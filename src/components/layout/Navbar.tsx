...
export function Navbar() {
    return (
        <div className="fixed top-6 inset-x-0 z-50 flex justify-center px-4 pointer-events-none">
            <header className="pointer-events-auto flex items-center gap-4 sm:gap-8 rounded-full border border-slate-200/60 bg-white/20 px-6 py-3 backdrop-blur-x0.7 shadow-lg shadow-blue-900/5 transition-all duration-300 hover:shadow-xl hover:shadow-blue-900/10">
                ...
                <a
                    href="mailto:haniwanice@gmail.com"
